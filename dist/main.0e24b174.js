...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/amplitudejs/dist/amplitude.js":[function(require,module,exports) {
var define;
var process = require("process");
...
},{"process":"../../.npm-global/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/performance-now/lib/performance-now.js":[function(require,module,exports) {
var process = require("process");
...
},{"process":"../../.npm-global/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/raf/index.js":[function(require,module,exports) {
...
},{"performance-now":"node_modules/performance-now/lib/performance-now.js"}],"node_modules/lerp/index.js":[function(require,module,exports) {
function lerp(v0, v1, t) {
    return v0*(1-t)+v1*t
}
module.exports = lerp
},{}],"node_modules/siriwave/dist/siriwave.m.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(SiriWave, [{
    ...
    value: function lerp(propertyStr) {
      this[propertyStr] = (0, _lerp2.default)(this[propertyStr], this.interpolation[propertyStr], this.opt.lerpSpeed);
    ...
    value: function startDrawCycle() {
      ...
      (0, _raf.default)(this.startDrawCycle.bind(this), 20);
    }
    /* API */
...
},{"raf":"node_modules/raf/index.js","lerp":"node_modules/lerp/index.js"}],"ts/main.ts":[function(require,module,exports) {
"use strict";
...
var axios_1 = __importDefault(require("../node_modules/axios"));

var amplitudejs_1 = __importDefault(require("../node_modules/amplitudejs"));

var siriwave_1 = __importDefault(require("../node_modules/siriwave")); // Variables


var URL_API = 'http://republicaweb.es/wp-json/ssp/v1/episodes/';
var COVER = 'https://republicaweb.es/wp-content/themes/republica/dist/images/logo-republica-web-v2.png';
var lastEpisode = undefined;
var mySiriWare = undefined; // Funcions

function start() {
  axios_1.default.get(URL_API).then(function (response) {
    // handle success
    lastEpisode = response.data[0]; //document.querySelector('#player').setAttribute('src', lastEpisode.meta.audio_file)

    startPlayer(lastEpisode["title"].rendered, "test", lastEpisode["meta"].audio_file, COVER);
...
function startPlayer(name, episode, url, cover) {
  ...
  handlesProgressbar(); // Init Way

  mySiriWare = new siriwave_1.default({
...
function handlesProgressbar() {
  ...
  document.getElementById('song-played-progress').addEventListener('click', function (e) {
    ...
    amplitudejs_1.default.setSongPlayedPercentage(parseFloat(x) / parseFloat(this.offsetWidth) * 100);
  });
} // Init


start();
},{"../node_modules/axios":"node_modules/axios/index.js","../node_modules/amplitudejs":"node_modules/amplitudejs/dist/amplitude.js","../node_modules/siriwave":"node_modules/siriwave/dist/siriwave.m.js"}],"../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
